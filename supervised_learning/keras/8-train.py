...
def train_model(network, data, labels, batch_size, epochs,
    ...
    Args:
        ...
        save_best (bool, optionnel): Indique si le modèle doit être sauvegardé
            uniquement lorsque la validation loss atteint un nouveau minimum.

        filepath (str, optionnel): Chemin du fichier où sauvegarder le modèle
            lorsque save_best est True.
